...
pub(crate) use profile_config::{
    SavedInstallProfile, load_saved_profile, save_selected_profile, set_doctor_suppression,
};
...
pub(crate) use skill_install::{
    SkillPackManifest, SkillVerifyStatus, install_skills, verify_installed_skills,
};

#[cfg(test)]
pub(crate) use profile_config::{load_profile_from_path, save_profile_to_path};
#[cfg(test)]
